...
outbreaks, which according to a government report is August 2022 
...
seal_dead <- data_seal %>%
  ...
  filter(
    # Ensures observations are no earlier than August 2022
    observed_on >= as.Date("2022-08-01") 
  )
...
So we've retrieved all the data of dead seals observed in 
